...
python test.py \
    ...
    --variant=$variant \
    --aux=True \
    --out_dir='/gpfs/data/davolilab/projects/melanoma_scrna/bulk_analysis/image_analysis/HNSC.HPVneg_9p_loss/results/X1/pred' \
    --tst_df='/gpfs/data/davolilab/projects/melanoma_scrna/bulk_analysis/image_analysis/HNSC.HPVneg_9p_loss/results/X1/data/tiles_with_labels_CPTAC_only.csv' \
    --lab_col='label' \
    --lab_level='Patient_ID' \
    --agg_level='Patient_ID' \
    --saved_model_dir='/gpfs/data/davolilab/projects/melanoma_scrna/bulk_analysis/image_analysis/HNSC.HPVneg_9p_loss/results/X1/model/panoptes_weights_final.h5' \
    --manifold_sample=0 \
    --seed=123456