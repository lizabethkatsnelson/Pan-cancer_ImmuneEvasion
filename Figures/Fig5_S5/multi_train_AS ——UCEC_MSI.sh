...
#SBATCH --output=/gpfs/data/proteomics/projects/Lisa/Image_Models/UCEC_MSI/scripts/logs/%x_%j.out
#SBATCH --error=/gpfs/data/proteomics/projects/Lisa/Image_Models/UCEC_MSI/scripts/logs/%x_%j.error
#SBATCH --gres=gpu:2

## to run:
# sbatch multi_train_AS.sh X1
...
### train model
conda run -n panoptes_tf29 python train.py \
    --multi_gpu=True \
    --variant=$var \
    --split=True \
    --split_ratio=0.8,0.1,0.1 \
    --out_dir=/gpfs/data/proteomics/projects/Lisa/Image_Models/UCEC_MSI/results/$var \
    --tile_idx_dir=/gpfs/data/proteomics/projects/Lisa/Image_Models/UCEC_MSI/idx_files/tiles.csv \
