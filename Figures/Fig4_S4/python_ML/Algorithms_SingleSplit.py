...
def invert_label(x):
    return np.abs(x - 1)
# %%
############### Definining Model and Controls List ###############
...
cancer_type_cell_line = "B16"

controls = pd.read_csv(f'E:/Immune_Evasion_Project/Mario/Controls/DataControls_{cancer_type}_AP2_{cancer_type_cell_line}.csv', index_col = 0)
controls.index.name = 'Gene-Symbol'
# %%
