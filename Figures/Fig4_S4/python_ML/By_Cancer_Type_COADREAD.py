...
BRCA_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_BRCA_AP2_COADREAD.csv")
BRCA_COADREAD_metadata
# %%
# Definining 'x' and 'y' sets
x = BRCA_COADREAD_metadata.iloc[:,0:6]
y = BRCA_COADREAD_metadata[['Gene_ID','Label']]
...
## Definining Control List
COADREAD_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_COADREAD_AP2_COADREAD.csv")
COADREAD_COADREAD_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = COADREAD_COADREAD_metadata.iloc[:,0:6]
y = COADREAD_COADREAD_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUAD_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUAD_AP2_COADREAD.csv")
LUAD_COADREAD_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUAD_COADREAD_metadata.iloc[:,0:6]
y = LUAD_COADREAD_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUSC_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUSC_AP2_COADREAD.csv")
LUSC_COADREAD_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUSC_COADREAD_metadata.iloc[:,0:6]
y = LUSC_COADREAD_metadata[['Gene_ID','Label']]
...
## Definining Control List
SKCM_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_SKCM_AP2_COADREAD.csv")
SKCM_COADREAD_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = SKCM_COADREAD_metadata.iloc[:,0:6]
y = SKCM_COADREAD_metadata[['Gene_ID','Label']]
...
## Definining Control List
PAAD_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_PAAD_AP2_COADREAD.csv")
PAAD_COADREAD_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = PAAD_COADREAD_metadata.iloc[:,0:6]
y = PAAD_COADREAD_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRC_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRC_AP2_COADREAD.csv")
KIRC_COADREAD_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRC_COADREAD_metadata.iloc[:,0:6]
y = KIRC_COADREAD_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRP_COADREAD_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRP_AP2_COADREAD.csv")
KIRP_COADREAD_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRP_COADREAD_metadata.iloc[:,0:6]
y = KIRP_COADREAD_metadata[['Gene_ID','Label']]
