...
BRCA_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_BRCA_hgene_TOP50.csv")
BRCA_TOP50_metadata
# %%
# Definining 'x' and 'y' sets
x = BRCA_TOP50_metadata.iloc[:,0:6]
y = BRCA_TOP50_metadata[['Gene_ID','Label']]
...
## Definining Control List
COADREAD_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_COADREAD_hgene_TOP50.csv")
COADREAD_TOP50_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = COADREAD_TOP50_metadata.iloc[:,0:6]
y = COADREAD_TOP50_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUAD_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUAD_hgene_TOP50.csv")
LUAD_TOP50_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUAD_TOP50_metadata.iloc[:,0:6]
y = LUAD_TOP50_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUSC_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUSC_hgene_TOP50.csv")
LUSC_TOP50_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUSC_TOP50_metadata.iloc[:,0:6]
y = LUSC_TOP50_metadata[['Gene_ID','Label']]
...
## Definining Control List
SKCM_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_SKCM_hgene_TOP50.csv")
SKCM_TOP50_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = SKCM_TOP50_metadata.iloc[:,0:6]
y = SKCM_TOP50_metadata[['Gene_ID','Label']]
...
## Definining Control List
PAAD_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_PAAD_hgene_TOP50.csv")
PAAD_TOP50_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = PAAD_TOP50_metadata.iloc[:,0:6]
y = PAAD_TOP50_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRC_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRC_hgene_TOP50.csv")
KIRC_TOP50_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRC_TOP50_metadata.iloc[:,0:6]
y = KIRC_TOP50_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRP_TOP50_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRP_hgene_TOP50.csv")
KIRP_TOP50_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRP_TOP50_metadata.iloc[:,0:6]
y = KIRP_TOP50_metadata[['Gene_ID','Label']]
