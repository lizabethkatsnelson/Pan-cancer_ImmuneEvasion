...
BRCA_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_BRCA_AP2_RENCA.csv")
BRCA_RENCA_metadata
# %%
# Definining 'x' and 'y' sets
x = BRCA_RENCA_metadata.iloc[:,0:6]
y = BRCA_RENCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
COADREAD_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_COADREAD_AP2_RENCA.csv")
COADREAD_RENCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = COADREAD_RENCA_metadata.iloc[:,0:6]
y = COADREAD_RENCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUAD_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUAD_AP2_RENCA.csv")
LUAD_RENCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUAD_RENCA_metadata.iloc[:,0:6]
y = LUAD_RENCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUSC_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUSC_AP2_RENCA.csv")
LUSC_RENCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUSC_RENCA_metadata.iloc[:,0:6]
y = LUSC_RENCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
SKCM_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_SKCM_AP2_RENCA.csv")
SKCM_RENCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = SKCM_RENCA_metadata.iloc[:,0:6]
y = SKCM_RENCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
PAAD_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_PAAD_AP2_RENCA.csv")
PAAD_RENCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = PAAD_RENCA_metadata.iloc[:,0:6]
y = PAAD_RENCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRC_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRC_AP2_RENCA.csv")
KIRC_RENCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRC_RENCA_metadata.iloc[:,0:6]
y = KIRC_RENCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRP_RENCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRP_AP2_RENCA.csv")
KIRP_RENCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRP_RENCA_metadata.iloc[:,0:6]
y = KIRP_RENCA_metadata[['Gene_ID','Label']]
