...
BRCA_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_BRCA_AP2_BRCA.csv")
BRCA_BRCA_metadata
# %%
# Definining 'x' and 'y' sets
x = BRCA_BRCA_metadata.iloc[:,0:6]
y = BRCA_BRCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
COADREAD_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_COADREAD_AP2_BRCA.csv")
COADREAD_BRCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = COADREAD_BRCA_metadata.iloc[:,0:6]
y = COADREAD_BRCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUAD_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUAD_AP2_BRCA.csv")
LUAD_BRCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUAD_BRCA_metadata.iloc[:,0:6]
y = LUAD_BRCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
LUSC_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_LUSC_AP2_BRCA.csv")
LUSC_BRCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = LUSC_BRCA_metadata.iloc[:,0:6]
y = LUSC_BRCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
SKCM_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_SKCM_AP2_BRCA.csv")
SKCM_BRCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = SKCM_BRCA_metadata.iloc[:,0:6]
y = SKCM_BRCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
PAAD_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_PAAD_AP2_BRCA.csv")
PAAD_BRCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = PAAD_BRCA_metadata.iloc[:,0:6]
y = PAAD_BRCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRC_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRC_AP2_BRCA.csv")
KIRC_BRCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRC_BRCA_metadata.iloc[:,0:6]
y = KIRC_BRCA_metadata[['Gene_ID','Label']]
...
## Definining Control List
KIRP_BRCA_metadata = pd.read_csv("E:/Immune_Evasion_Project/Output/DataControls_KIRP_AP2_BRCA.csv")
KIRP_BRCA_metadata
# %%
#################### DEFINING 'x' and 'y' SETS ####################

x = KIRP_BRCA_metadata.iloc[:,0:6]
y = KIRP_BRCA_metadata[['Gene_ID','Label']]
